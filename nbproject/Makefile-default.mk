...
# Source Files
SOURCEFILES=src/AD.c src/BOARD.c src/ES_Framework.c src/FindAmmoHSM.c src/FindOpponentHSM.c src/FindPortalHSM.c src/IO_Ports.c src/LED.c src/R2BJT2_Main.c src/R2_BJT2_HSM.c src/RC_Servo.c src/driveMotor.c src/pwm.c src/serial.c src/R2Events.c src/R2BumperService.c src/TrackWireEvents.c src/R2TapeEvents.c src/R2BeaconEvents.c
...
${OBJECTDIR}/src/R2BeaconEvents.o: src/R2BeaconEvents.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src 
	@${RM} ${OBJECTDIR}/src/R2BeaconEvents.o.d 
	@${RM} ${OBJECTDIR}/src/R2BeaconEvents.o 
	@${FIXDEPS} "${OBJECTDIR}/src/R2BeaconEvents.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"include" -MMD -MF "${OBJECTDIR}/src/R2BeaconEvents.o.d" -o ${OBJECTDIR}/src/R2BeaconEvents.o src/R2BeaconEvents.c   
...
${OBJECTDIR}/src/R2BeaconEvents.o: src/R2BeaconEvents.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/R2BeaconEvents.o.d 
	@${RM} ${OBJECTDIR}/src/R2BeaconEvents.o 
	@${FIXDEPS} "${OBJECTDIR}/src/R2BeaconEvents.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"include" -MMD -MF "${OBJECTDIR}/src/R2BeaconEvents.o.d" -o ${OBJECTDIR}/src/R2BeaconEvents.o src/R2BeaconEvents.c   
