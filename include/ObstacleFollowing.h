...
#ifndef OBSTACLE_FOLLOWING_H  // <- This should be changed to your own guard on both
#define OBSTACLE_FOLLOWING_H  //    of these lines
...
/**
 * @Function InitObstacleFollowing(void)
