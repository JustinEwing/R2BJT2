 ...
 *
 * There is another file for the SubHSM's that is slightly differet, and
...
#ifndef HSM_R2_BJT2_H
#define HSM_R2_BJT2_H
...
#define LIST_OF_HSM_STATES(STATE)\
        STATE(InitHSMtate) /*We typically use this as the InitState*/ \
        STATE(FindAmmo)       \
        STATE(FindOpponent)  \
        STATE(FindPortal) \
