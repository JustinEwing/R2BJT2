...
#ifndef TAPE_FOLLOWING_H  // <- This should be changed to your own guard on both
#define TAPE_FOLLOWING_H  //    of these lines
...
/**
 * @Function InitTapeFollowing(void)
