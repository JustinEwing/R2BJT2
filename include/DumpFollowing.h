...
#ifndef DUMP_FOLLOWING_H  // <- This should be changed to your own guard on both
#define DUMP_FOLLOWING_H  //    of these lines
...
/**
 * @Function InitDumpFollowing(void)
